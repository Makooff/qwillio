...
Pour que je puisse **assembler la vidéo finale** depuis le terminal (sans passer par Premiere Pro), il faut `ffmpeg` installé.
...
Pas de Premiere Pro nécessaire si on accepte un montage purement programmatique (moins fin sur la color grade et les lower-thirds, mais 80% du chemin couvert).
