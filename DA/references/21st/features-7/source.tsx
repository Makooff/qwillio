...
// Composant : Features 7 (@meschacirung) — demo id 1905, component id 1727
// URL : https://21st.dev/@meschacirung/components/features-7
// Install : npx shadcn@latest add "https://21st.dev/r/meschacirung/features-7?api_key=$API_KEY_21ST"
