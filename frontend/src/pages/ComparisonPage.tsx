  ...
  return (
    <div className="bg-white text-[#1d1d1f] min-h-screen">
      ...
      <main aria-labelledby="comparison-heading">
              ...
              if (block.type === 'table') {
                return (
                  <figure key={i} className="my-4">
                    <div className="overflow-x-auto rounded-2xl border border-[#1d1d1f]/10">
        ...
        >
          <div
            className="max-w-[820px] mx-auto rounded-3xl p-8 md:p-10 text-white"
          ...
          >
            ...
            <p className="text-white/75 text-[15px] leading-relaxed mb-6 max-w-[540px]">
              {isFr
