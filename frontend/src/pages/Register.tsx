  ...
  return (
    ...
    >
          ...
          {step === 'form' ? (
            <div className="flex flex-col gap-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  ...
                  style={{ background: loading ? 'oklch(40% 0.10 264)' : D.accent, color: loading ? D.text2 : 'oklch(98% 0.004 265)' }}
                >
            ...
            <div className="auth-in text-center max-w-sm mx-auto">
              ...
              <button
                ...
                className="border rounded-2xl px-5 py-3 text-[13px] font-medium cursor-pointer transition-colors bg-transparent hover:border-[oklch(56%_0.22_264/0.45)] hover:text-[oklch(63%_0.21_264)] disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      <section className="hidden lg:block flex-1 relative p-4">
        ...
        >
          <div className="absolute pointer-events-none" style={{ inset: 0, background: 'radial-gradient(ellipse 460px 360px at 85% 8%, oklch(56% 0.22 264 / 0.10) 0%, transparent 70%)' }} />
