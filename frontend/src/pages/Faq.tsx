...
const FAQ_FR: QA[] = [
  ...
  {
    q: 'Combien ça coûte ?',
    a: "Le plan Solo est à 99 € par mois : 250 minutes incluses, soit environ 100 appels, en français, hébergement UE. Au-delà, les minutes supplémentaires sont à 0,45 €. Les plans supérieurs ajoutent du volume et des fonctions avancées : Starter 249 € (750 min), Pro 599 € (2 000 min), Enterprise 1 290 € (5 000 min). Premier mois offert sans carte, résiliable au mois, remise de 20 % en annuel.",
  },
  {
...
const FAQ_EN: QA[] = [
  ...
  },
  {
    ...
    a: 'The Solo plan is €99 per month: 250 minutes included, roughly 100 calls, French, EU hosting. Beyond that, extra minutes are €0.45. Higher plans add volume and advanced features: Starter €249 (750 min), Pro €599 (2,000 min), Enterprise €1,290 (5,000 min). First month free with no card, cancel monthly, 20% off annually.',
  },
  {
