      ...
      <div className="w-full max-w-md text-center">
        ...
        {status === 'success' && (
          <>
            ...
            <h1 className="text-2xl font-semibold tracking-tight mb-2">{t('confirm.success')}</h1>
            <p className="text-[#86868b]">{t('confirm.redirect')}</p>
          </>
        )}
        ...
        {status === 'error' && (
          <>
            ...
            <h1 className="text-2xl font-semibold tracking-tight mb-2">{t('confirm.failed')}</h1>
