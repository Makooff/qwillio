  ...
  return (
    <div>
      ...
      <div className="rounded-2xl border border-[#d2d2d7]/60 bg-white p-5 mb-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          {stripeConnected && (
            <a href="#" className="inline-flex items-center gap-1 text-xs text-[#7349fe] font-medium hover:underline">
          ...
          <div className="space-y-5">
            <div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  min={0}
                  max={100}
                  className="w-24 text-sm border border-[#d2d2d7]/60 rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#7349fe]/30"
                />
            ...
            <div>
              ...
              <select
                ...
                className="w-full text-sm border border-[#d2d2d7]/60 rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#7349fe]/30 bg-white"
              >
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="flex-1 text-sm border border-[#d2d2d7]/60 rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#7349fe]/30 disabled:opacity-40 disabled:cursor-not-allowed"
                />
              </div>
            </div>
