          ...
          <div className="flex items-center justify-between mb-5">
            ...
            <div className="flex items-center gap-2">
              ...
              <button onClick={() => setAutoReplyEnabled(v => !v)}>
                {autoReplyEnabled
                  ? <ToggleRight size={22} className="text-[#7349fe]" />
          ...
          <div className="space-y-1">
            <AnimatePresence mode="wait">
              {visibleEmails.length === 0 ? (
                ...
                >
                  <div className="w-8 h-8 rounded-lg bg-[#7349fe]/10 flex items-center justify-center flex-shrink-0 text-[#7349fe] font-semibold text-sm">
                ...
                return (
                  <div key={tab.key} className="flex items-center justify-between">
                    ...
                    <button onClick={() => toggleRule(tab.key)}>
                      {rules[tab.key]
                        ? <ToggleRight size={20} className="text-[#7349fe]" />
          ...
          <div className="rounded-2xl border border-[#d2d2d7]/60 bg-white p-5">
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="flex-1 text-sm border border-[#d2d2d7]/60 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-[#7349fe]/30"
              />
            </div>
          </div>
        </div>
        ...
        <div className="space-y-2">
          {EMAILS.filter(e => e.tab === 'urgent' && !e.autoReplied).map(email => (
            <div key={email.id} className="flex items-center gap-3 p-3 rounded-xl bg-[#f5f5f7] border border-[#d2d2d7]/40">
              ...
              <div className="flex gap-2">
                <button className="px-3 py-1.5 text-xs font-medium bg-[#7349fe] text-white rounded-lg hover:bg-[#7349fe] transition-colors">Reply</button>
        ...
        <div className="space-y-2">
          {TEMPLATES.map(tmpl => (
            <div key={tmpl.id} className="flex items-start gap-3 p-3 rounded-xl hover:bg-[#f5f5f7] transition-colors group">
              <div className="w-8 h-8 rounded-lg bg-[#7349fe]/10 flex items-center justify-center flex-shrink-0">
                <Edit3 size={14} className="text-[#7349fe]" />
              </div>
              <div className="flex-1 min-w-0">
              ...
              <button
                ...
                className="text-xs text-[#7349fe] font-medium opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap"
              >
                Edit
              </button>
            </div>
        ...
        <AnimatePresence>
          {editingTemplate && (
            ...
            >
              ...
              <textarea
                className="w-full text-sm border border-[#d2d2d7]/60 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#7349fe]/30 resize-none bg-white"
                rows={4}
