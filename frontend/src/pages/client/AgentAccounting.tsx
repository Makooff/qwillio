        ...
        <div className="h-56">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={REVENUE_DATA}>
              ...
              <Bar dataKey="revenue" fill="#7349fe" radius={[4, 4, 0, 0]} name="Revenue" />
            ...
            <tbody>
              {INVOICES.map((inv, i) => {
                ...
                return (
                  ...
                  >
                    <td className="py-3 font-medium text-[#7349fe] text-xs">{inv.id}</td>
                    ...
                    <td className="py-3">
                      {inv.status !== 'paid' && (
                        <button className="text-xs text-[#7349fe] font-medium hover:underline">Send reminder</button>
                      )}
                    </td>
                  </motion.tr>
                );
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="rounded-2xl border border-[#d2d2d7]/60 bg-white p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-xl bg-[#7349fe]/5 border border-[#7349fe]/20 p-3 mt-2">
              <p className="text-xs text-[#7349fe]">Reminders are sent via email and SMS to clients with outstanding invoices.</p>
            </div>
          </div>
        </div>
            ...
            {PL_DATA.map(row => (
              <div
                ...
                className={`flex items-center justify-between py-2 px-3 rounded-xl ${
                  row.type === 'total'
                    ? 'bg-[#7349fe]/5 border border-[#7349fe]/20'
                    : 'hover:bg-[#f5f5f7]'
                } transition-colors`}
              >
                <span className={`text-sm ${row.type === 'total' ? 'font-semibold text-[#7349fe]' : ''}`}>{row.label}</span>
