        ...
        {selectedLead && (
          <>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
              ...
              aria-hidden="true"
            />
            {/* Même surface que le panneau des appels : #131313 OPAQUE, pas
                `bg-white/[0.02]`, qui laissait lire la liste floutée au
                travers de la fiche. L'entête est opaque pour la même raison :
