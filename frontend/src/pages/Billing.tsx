    ...
    <main aria-label="Tableau de bord facturation" className="px-4 sm:px-6 py-6 max-w-3xl mx-auto space-y-5">
      ...
      {loading ? (
        ...
        <div
          ...
          style={{
            borderColor: 'oklch(60.4% 0.213 285.5 / 0.2)',
            background: 'oklch(60.4% 0.213 285.5 / 0.06)',
          }}
        >
          <p className="text-xs font-semibold tracking-widest uppercase mb-1"
            style={{ color: 'oklch(60.4% 0.213 285.5 / 0.6)' }}>
            Monthly Recurring Revenue
          </p>
          <p
            className="text-4xl font-bold tabular-nums"
            style={{ color: 'oklch(74% 0.15 305)' }}
          >
            {fmt(data.mrr)} €
          </p>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-5">
            ...
            <p className="text-2xl font-bold tabular-nums" style={{ color: 'oklch(74% 0.15 305)' }}>
