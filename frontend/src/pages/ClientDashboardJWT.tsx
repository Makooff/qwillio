          ...
          <div>
            ...
            {ov.isTrial && (
              <div className="flex items-center gap-3 bg-[#7a5fff]/5 border border-[#7a5fff]/20 rounded-2xl px-6 py-4">
                ...
                <a href="#" className="ml-auto inline-flex items-center gap-1 text-sm font-medium text-[#7a5fff] hover:underline">
                ...
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={data.analytics.dailyTrends}>
                      ...
                      />
                      <Area type="monotone" dataKey="totalCalls" stroke="#7a5fff" fill="url(#blueGrad2)" strokeWidth={2} name={t('portal.analytics.calls')} />
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
              </div>
