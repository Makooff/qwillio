  ...
  },
  {
    ...
    content: {
      en: [
        ...
        { type: 'h2', text: 'Where Qwillio wins' },
        { type: 'p', text: "Qwillio was built for exactly the market Rosie does not serve: French and bilingual Belgian and French SMBs who need GDPR-safe EU data residency, native CRM without Zapier duct tape, and a free 7-day trial. Above 500 calls a month, Qwillio Solo and Starter also stop leaking overage the way Rosie does at 0.25 USD per minute above the tier." },
        ...
        { type: 'h2', text: 'Bottom line' },
        { type: 'p', text: "Rosie is not being replaced everywhere. It is the right pick for the price-first English-only US SMB. But for a Belgian or French SMB that needs French-native voice, EU hosting, and a real 7-day trial, Qwillio is the honest recommendation in 2026." },
      ],
      fr: [
        ...
        { type: 'h2', text: 'Là où Qwillio gagne' },
        { type: 'p', text: "Qwillio a été bâtie exactement pour le marché que Rosie ne sert pas : les PME françaises et belges bilingues qui ont besoin de résidence des données UE compatible RGPD, d'un CRM natif sans scotch Zapier, et d’un essai gratuit de 7 jours. Au-dessus de 500 appels par mois, Qwillio Solo et Starter arrêtent aussi de fuir en dépassement comme Rosie à 0,25 USD par minute au-delà du palier." },
        ...
        { type: 'h2', text: 'Verdict' },
        { type: 'p', text: "Rosie ne disparaît pas partout. C'est le bon choix pour la PME US 100 % anglophone qui achète au prix. Mais pour une PME belge ou française qui a besoin de la voix française native, de l'hébergement UE et d’un vrai essai de 7 jours, Qwillio est la recommandation honnête en 2026." },
      ],
    },
  },
  {
