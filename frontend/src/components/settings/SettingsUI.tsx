...
export const inputCls = [
  ...
  'focus:border-[oklch(56%_0.22_299)/50] placeholder-white/25',
].join(' ');
...
export function ConfigSection({
  ...
  const btnBg = accent === 'violet'
    ...
    : 'bg-[oklch(56%_0.22_299)] hover:bg-[oklch(52%_0.22_299)]';
  const iconColor = accent === 'violet' ? 'text-[oklch(67%_0.26_299)]' : 'text-[oklch(74%_0.18_299)]';
        ...
        <div className="flex flex-wrap gap-2">
          {tags.map((tag) => (
            <span
              ...
              style={{ background: 'oklch(56% 0.22 299 / 0.15)', color: 'oklch(74% 0.18 299)' }}
            >
              {tag}
              <button
                type="button"
