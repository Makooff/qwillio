...
export const NICHE_SCRIPTS: Record<string, NicheScript> = {
  dental: {
    ...
    pain: `How many of those get missed in a week, roughly? Most practices guess two or three and it turns out to be closer to ten.`,
    ...
    setupFeeObjection: `Il n'y a pas de frais d'installation chez nous, la mise en route est comprise. Vous payez l'abonnement, et les 7 premiers jours sont gratuits.`,
  ...
  law: {
    ...
    pain: `How many after-hours calls do you reckon you miss in a week? Most firms underestimate it until they measure.`,
  ...
  salon: {
    ...
    pain: `How many booking calls do you miss on a busy day, would you say?`,
  ...
  restaurant: {
    ...
    pain: `Un vendredi soir, combien d'appels de réservation partent sans réponse, à peu près ?`,
  ...
  hotel: {
    ...
    pain: `Combien de réservations directes vous pensez perdre chaque mois à cause des appels hors horaires ?`,
  ...
  auto: {
    ...
    pain: `How many calls come in while you're under a car? What's the average ticket on those?`,
...
export const DEFAULT_SCRIPT: NicheScript = {
  ...
  pain: `How many calls would you say go unanswered in a week? Most owners are surprised once they actually count.`,
...
export const NICHE_SCRIPTS_FR: Record<string, NicheScript> = {
  cabinet_dentaire: {
    ...
    pain: `Sur une semaine, vous en ratez combien à peu près ? La plupart des cabinets disent deux ou trois, et quand on mesure c'est plutôt dix.`,
  ...
  cabinet_avocat: {
    ...
    pain: `Hors horaires, vous pensez en rater combien par semaine ? La plupart des cabinets sous-estiment tant qu'ils n'ont pas mesuré.`,
  ...
  salon_coiffure: {
    ...
    pain: `Un jour chargé, vous ratez combien d'appels de réservation, à votre avis ?`,
  ...
  restaurant: {
    ...
    pain: `Un vendredi soir, combien d'appels de réservation partent sans réponse, à peu près ? Et le couvert moyen chez vous, c'est quel montant ?`,
  ...
  hotel: {
    ...
    pain: `Combien de réservations directes vous pensez perdre chaque mois à cause des appels hors horaires ? Ce sont autant de commissions OTA que vous payez en plus.`,
  ...
  agence_marketing: {
    ...
    pain: `Vous ratez combien d'appels de prospects par semaine ? Et une mission moyenne, c'est quel montant chez vous ?`,
  ...
  cabinet_comptable: {
    ...
    pain: `En période de déclarations, vous en ratez combien par semaine ? Et une mission moyenne, c'est combien d'heures ?`,
  ...
  agence_immobiliere: {
    ...
    pain: `Combien d'appels d'acquéreurs et de vendeurs partent sans réponse chaque semaine, à votre avis ?`,
  ...
  cabinet_recrutement: {
    ...
    pain: `Vous ratez combien d'appels de candidats et de clients par semaine ? Un placement, c'est quelle commission chez vous ?`,
  ...
  agence_web: {
    ...
    pain: `Combien d'appels de prospects vous ratez par semaine ? Et un projet moyen, c'est quel budget ?`,
  ...
  garage_auto: {
    ...
    pain: `Quand vous êtes sous une voiture, les appels partent où ? Vous en ratez combien par semaine, et c'est quoi le ticket moyen ?`,
  ...
  coach: {
    ...
    pain: `Vous ratez combien d'appels de prospects par semaine ? Et une séance, c'est quel tarif ?`,
  ...
  consultant_formation: {
    ...
    pain: `Combien d'appels de DRH partent sans réponse chaque semaine ? Une mission inter-entreprises, c'est quel montant ?`,
...
export const DEFAULT_SCRIPT_FR: NicheScript = {
  ...
  pain: `Vous diriez que combien d'appels partent sans réponse sur une semaine ? La plupart des patrons sont surpris quand ils comptent vraiment.`,
